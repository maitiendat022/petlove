                    ...
                    <div class="col-12 mt-3">
                        <div class="card-body">
                            <form action="{{ route('users.update', $user->id) }}" method="POST"
                                        ...
                                        <div class="row ml-1">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="gender">
                                                        ...
                                                        <option value="Nữ" {{ $user->gender == 'Nữ' ? 'selected' : ''
                                                            }}>Nữ</option>
                                                    </select>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input
                                                        pattern="\d*"
                                                        oninput="this.value = this.value.replace(/\D/, '')" type="text"
                                ...
                                <a href="{{ route('users.index') }}" style="margin-left: 400px"
                                    class="btn btn-danger btn-fill mt-2 mb-4">Hủy</a>
                            </form>
                        </div>
                    </div>
                </div>
